package edu.estu.estufastingrestapi.core.model.constants;
...
public class Validation {
    ...
    public class Common {
        ...
        public final String RGX_NAT_ID = "\\d{11}";
        ...
        public final String RGX_ALPHA_2 = "\\[a-zA-Z]{2}";
        public final String RGX_ALPHA_3 = "\\[a-zA-Z]{3}";
    }
