...
public class UserController {
    ...
    @PreAuthorize("@securityChecker.isLoggedInUser(#username) || hasAnyAuthority(T(edu.estu.estufastingrestapi.core.domain.constants.UserRole$Name).SUPER_ADMIN)")
    @PutMapping("/update/password")
    public ResponseEntity<ApiResponse> updatePassword(
            @RequestParam @NotEmpty(message = MsgCode.VALIDATION_USER_EMAIL_NOT_EMPTY) String username,
            @NotEmpty(message = MsgCode.VALIDATION_USER_PASSWORD_NOT_EMPTY) @RequestParam String password) {
        return ResponseBuilder.status(HttpStatus.OK)
