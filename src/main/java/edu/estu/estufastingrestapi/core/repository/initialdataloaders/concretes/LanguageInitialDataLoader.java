...
@Component
public class LanguageInitialDataLoader extends BaseInitialDataLoader<Language, Integer> {
    ...
    @Override
    public Collection<Language> getData() {
        if (this.data != null) return this.data;
        Collection<Language> data = new ArrayList<>();
